...
export class SubscriptionTreeProvider implements ITreeProvider<Subscription>, VSCode.TreeDataProvider<Node> {
  private readonly onDidChangeTreeDataEmitter: VSCode.EventEmitter<Node | undefined> = new VSCode.EventEmitter<Node | undefined>();
  readonly onDidChangeTreeData: VSCode.Event<Node | undefined> = this.onDidChangeTreeDataEmitter.event;
